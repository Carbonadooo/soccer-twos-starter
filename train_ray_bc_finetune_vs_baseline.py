...
def parse_args():
    ...
    parser.add_argument("--experiment-name", default="PPO_bc_finetune_vs_baseline")
    return parser.parse_args()


class BlueTeamVsBaselineEnv(MultiAgentEnv):
...
def create_env(env_config=None):
    ...
    return BlueTeamVsBaselineEnv(config_dict)
...
if __name__ == "__main__":
    ...
    tune.registry.register_env("BlueTeamVsBaseline", create_env)

...
class BaselineBCOpponentPoolAgent(AgentInterface):
    def __init__(self, env):
        super().__init__()
        self.name = "BaselineBCOpponentPoolAgent"
    ...
    def _load_checkpoint(self):
        ...
        if checkpoint_path is None:
            print("Opponent-pool finetune checkpoint not found. Agent will use random initial weights.")
            return

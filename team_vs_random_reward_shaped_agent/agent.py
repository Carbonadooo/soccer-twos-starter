...
class TeamVsRandomRewardShapedAgent(AgentInterface):
    """
    PPO team policy trained with train_ray_team_vs_random_reward_shaping.py.
    ...
    def __init__(self, env):
        ...
        self.model.eval()
        self.name = "TeamVsRandomRewardShapedPPO"
